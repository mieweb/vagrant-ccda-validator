...
wget -nv https://github.com/siteadmin/reference-ccda-validator/releases/download/1.1.0/referenceccdaservice.war -O /var/lib/tomcat/webapps/referenceccdaservice.war
